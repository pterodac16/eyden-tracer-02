...
//	auto shd6 = std::make_shared<CShaderEyelight>(RGB(1, 1, 1)); // white surface
	...
	auto shd1 = std::make_shared<CShaderPhong>(scene, RGB(1, 0, 0), 0.1f, 2.0f, 2.0f, 40); // red surface
	auto shd2 = std::make_shared<CShaderPhong>(scene, RGB(0, 1, 0), 0.1f, 2.0f, 2.0f, 40); // green surface
	auto shd3 = std::make_shared<CShaderPhong>(scene, RGB(0, 0, 1), 0.1f, 2.0f, 2.0f, 40); // blue surface
	auto shd4 = std::make_shared<CShaderPhong>(scene, RGB(1, 1, 0), 0.1f, 2.0f, 2.0f, 40); // yellow surface
	auto shd5 = std::make_shared<CShaderPhong>(scene, RGB(0, 1, 1), 0.1f, 2.0f, 2.0f, 40); // cyan surface
	auto shd6 = std::make_shared<CShaderPhong>(scene, RGB(1, 1, 1), 0.1f, 2.0f, 2.0f, 40); // white surface
